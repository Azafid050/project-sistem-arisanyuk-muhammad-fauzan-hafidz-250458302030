...
<div class="bg-white shadow-2xl rounded-xl p-8 border border-gray-100">
    ...
    <div class="pt-4 flex justify-end space-x-4">
        ...
        {{-- Tombol Kembali --}}
        <a href="{{ route('groups.anggota.index_anggota') }}" wire:navigate class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-lg shadow-md text-base font-medium text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out">
            Kembali
        </a>
