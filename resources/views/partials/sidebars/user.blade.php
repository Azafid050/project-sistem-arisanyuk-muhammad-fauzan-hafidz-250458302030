<aside
    class="fixed inset-y-0 left-0 z-40 w-64 bg-white shadow-2xl shadow-indigo-200/50
           flex-col justify-between h-screen border-r border-indigo-50
           transform -translate-x-full
           md:flex md:sticky md:translate-x-0 md:top-0">
